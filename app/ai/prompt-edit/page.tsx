...
import { Wand2, Download, Upload, RefreshCw } from 'lucide-react';
...
export default function PromptEditPage() {
  ...
  const handleEdit = async () => {
    ...
    if (!image || !prompt.trim()) {
      setError('Please upload image and enter prompt');
      return;
    }
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2">Prompt Edit</h1>
            <p className="text-muted-foreground">Edit images using natural language prompts</p>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              <Button onClick={handleEdit} disabled={loading || !image} size="lg" className="w-full gap-2">
                {loading ? 'Editing...' : <>Apply Edit <Wand2 className="h-4 w-4" /></>}
              </Button>
            </div>
